...
st.image([data_overview, heatmap], caption='Data Overview')
...
st.image([genres_heatmap, genres_barchart], caption="Analysis of genres")
...
rating_distribution_genres = 'https://raw.githubusercontent.com/simondesh/FinalProjectWebsite/main/src/images/rating_distribution_by_genres.png'
