...
st.write( """
         After the whole analysis, we have the following findings:
          ...
          2. The high rating of a game may not depend on single genre or category, but here for simple analysis. When assuming that he performance of each genres is independent, we found out that Massively Multiplayer games tend to have much lower ratings than any other genre and RPG games have slightly better ratings than most.
